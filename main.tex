...
\section{Summary}
\tinygap \cvitem{}{\textbf{I am not currently looking for employment.}
...
%
  ...
  some phases of the optimizing Javascript compiler's (Crankshaft)
...
\cvitem{}{%
  {\small Most of the production code I've written is in \textbf{C++}
    ...
    personal projects. I am familiar with \textbf{Java} and \textbf{Python}.}}  {}
